...
export const Footer = () => {
	return (
		<footer className='bg-contrast-900'>
			<Container className='mb-6 pt-10 grid grid-cols-2 flex-col max-680px:flex'>
				<div>
					<Link href='/'>
						<Image
					...
					<nav className='mb-4 text-base text-white max-680px:text-[14px]'>
						<ul className='flex flex-wrap max-680px:flex-col gap-8 gap-y-4'>
							<li>
								<Link
				...
				<div className='flex items-start max-680px:justify-center justify-start justify-self-end max-md:flex-wrap max-md:justify-end'>
					<nav className='mr-6'>
						<ul className='max-680px:flex items-center gap-4 max-680px:my-4'>
							<li>
								<Link
									className='flex h-10 w-[140px] items-center justify-center rounded-[4px] border border-solid border-secondary-900'
									target='_blank'
									href='https://apps.apple.com/gb/app/ampere-online-business-banking/id1641508835'
								>
									<svg
										className='fill-secondary-900 text-white'
										width={114.86}
										height={38}
									>
			...
			<Container className='flex items-center gap-8 pb-10 max-680px:flex-col-reverse'>
				<div className='flex flex-col gap-2 text-[12px] leading-[18px] text-white'>
					<p>
						AMPERE is the registered trading name of NOVO WORLD LTD which is the developer and
						distributor of AMPERE applications. AMPR FINANCE LTD is the subsidiary of NOVO WORLD LTD
						providing the services. Financial services are provided by AMPR FINANCE LTD which is the
						EMD Distributor of Payrnet Limited an authorised Electronic Money Institution under firm
						reference number 900594 with the UK Financial Conduct Authority (FCA), registered in
						England with registration No 09883437 and registered office at Montacute Yards,
						Shoreditch High Street, London, E1 6HU, UK.
					</p>
					<p>
						The Financial Services Compensation Scheme does not cover electronic money products. No
						other compensation scheme exists to cover losses from your electronic money account.
						Your funds will be held in one or more segregated bank accounts with a regulated third
						party credit institution, in accordance with the provisions of the Electronic Money
						Regulations 2011.
					</p>
